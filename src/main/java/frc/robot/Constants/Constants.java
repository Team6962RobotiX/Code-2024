...
public final class Constants {
  ...
  public static final class SWERVE_DRIVE {
    ...
    public static class PHYSICS {
      public static final double ROTATIONAL_INERTIA                 = 1.5 * ((1.0 / 12.0) * ROBOT_MASS * (Math.pow(BUMPER_WIDTH, 2.0) + Math.pow(BUMPER_LENGTH, 2.0)));
  ...
  public static final class SHOOTER_PIVOT {
    ...
    public static final double ABSOLUTE_POSITION_OFFSET = Units.degreesToRotations(-149.281); // 93.15 - [ the angle measured from the front plate of shooter ] - [ rawAbsolutePosition from logs ]
