...
public final class Constants {
  ...
  public static final class SHOOTER_PIVOT {
    ...
    public static final double ABSOLUTE_POSITION_OFFSET = Units.degreesToRotations(-140.125 - 93.15 + 27); //  - [ rawAbsolutePosition from logs ] - 93.15 + [ the angle measured from the front plate of shooter ]
