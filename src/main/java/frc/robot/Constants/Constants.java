...
public final class Constants {
  ...
  public static final class LIMELIGHT {
    ...
    public static final Rotation2d NOTE_CAMERA_PITCH = Rotation2d.fromDegrees(-22.32);
    // x is forward, y is left, z is up
    public static final Translation3d NOTE_CAMERA_POSITION = new Translation3d(Units.inchesToMeters(9.5), 0.0, Units.inchesToMeters(25.5));
  ...
  public static final class SWERVE_DRIVE {
    ...
    public static final class AUTONOMOUS {
      ...
      public static final double ACCELERATION_REDUCTION = 4.0 * ((SWERVE_DRIVE.PHYSICS.MAX_LINEAR_ACCELERATION * SWERVE_DRIVE.ROBOT_MASS + ((SWERVE_DRIVE.PHYSICS.ROTATIONAL_INERTIA * SWERVE_DRIVE.PHYSICS.MAX_ANGULAR_ACCELERATION) / SWERVE_DRIVE.PHYSICS.DRIVE_RADIUS)) / (9.80 * SWERVE_DRIVE.ROBOT_MASS * SWERVE_DRIVE.FRICTION_COEFFICIENT));
