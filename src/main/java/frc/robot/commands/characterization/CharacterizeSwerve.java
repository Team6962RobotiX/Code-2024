...
import frc.robot.util.sysid.SysIdDrivetrainLogger;
import frc.robot.subsystems.drive.SwerveDrive;

public class CharacterizeSwerve extends CommandBase {
    ...
    public CharacterizeSwerve(SwerveDrive subsystem) {
    ...
    public void initialize() {
        ...
        // drivebase odometers.
        m_swerve.resetPose(m_swerve.getPose()); 
    ...
    public void execute() {
        ...
        double angularPosition = m_swerve.getHeading().getRadians();
